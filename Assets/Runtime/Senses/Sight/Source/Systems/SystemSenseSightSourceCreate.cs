...
namespace PerceptionECS
{
    ...
    public partial struct SystemSenseSightSourceCreate : ISystem
    {
        private EntityArchetype _archetype;

        public void OnCreate(ref SystemState state)
        {
            var types = new NativeArray<ComponentType>(6, Allocator.Persistent);
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            foreach (var (sourceBase, sourceEntity) in
                     SystemAPI.Query<ComponentSenseBase>()
                         .WithAll<ComponentSenseSightSource, EventSenseCreate>()
                         .WithEntityAccess())
            {
                ...
                buffer.SetComponentEnabled<EventSenseCreate>(sourceEntity, false);
            }
